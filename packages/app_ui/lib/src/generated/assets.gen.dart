...
class $AssetsFontsGen {
  ...
  String get interBold => 'packages/app_ui/assets/fonts/Inter-Bold.ttf';
  ...
  String get interLight => 'packages/app_ui/assets/fonts/Inter-Light.ttf';

  /// File path: assets/fonts/Inter-Medium.ttf
  String get interMedium => 'packages/app_ui/assets/fonts/Inter-Medium.ttf';

  /// File path: assets/fonts/Inter-Regular.ttf
  String get interRegular => 'packages/app_ui/assets/fonts/Inter-Regular.ttf';

  /// File path: assets/fonts/Inter-SemiBold.ttf
  String get interSemiBold => 'packages/app_ui/assets/fonts/Inter-SemiBold.ttf';
